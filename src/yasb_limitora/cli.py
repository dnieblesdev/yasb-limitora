...
from .setup_assist import (
    _SETUP_ASSIST_FLAG,
    _has_setup_assist_request,
    _run_setup_assist,
)
...
def main(
    ...
    *,
    ...
    # Private assist sentinel: dispatched before argv validation; inert without the request value.
    if args == (_SETUP_ASSIST_FLAG,) and _has_setup_assist_request(effective_environment):
