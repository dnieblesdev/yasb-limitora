...
def test_r10_junit_diagnostic_integration_contract(tmp_path: Path) -> None:
    ...
    cases = ((("--junitxml=r10-admission.xml",), "r10-admission.xml", "windows", r'File "C:\Users\Jane Doe\repo\test.py", line 12, in test_name password=SECRET; token=SECOND', 'R10 diagnostic: test=windows; line=12; message=File "[PATH]", line 12, in test_name [REDACTED]; [REDACTED]', None), (("--junitxml=r10-admission.xml",), "r10-admission.xml", "posix", r"File '/home/Jane Doe/repo/test.py', line 7, in test_name api_key='VALUE'", "R10 diagnostic: test=posix; line=7; message=File '[PATH]', line 7, in test_name [REDACTED]", None), (("--junitxml=r10-admission.xml",), "r10-admission.xml", "relative", r"tests/test_parser.py:23: message credential=VALUE", "R10 diagnostic: test=relative; line=23; message=tests/test_parser.py:23: message [REDACTED]", None), (("--junitxml=r10-admission.xml",), "r10-admission.xml", "cap", "tests/test_parser.py:99: " + "x" * 300, ("R10 diagnostic: test=cap; line=99; message=tests/test_parser.py:99: " + "x" * 300)[:240], None), (("--junitxml=r10-admission.xml",), "r10-admission.xml", "malformed", "MALFORMED", "diagnostics withheld", "xml"), (("--junitxml=r10-yasb-experience.xml",), "r10-yasb-experience.xml", "missing", None, "diagnostics withheld", "args-file"), (("--junitxml=not-junitxml",), "r10-admission.xml", "regex", "ignored", "diagnostics withheld", "args-match"), (("--junitxml=r10-admission.xml", "--junitxml=r10-admission.xml"), "r10-admission.xml", "duplicate-case", "ignored", "diagnostics withheld", "args-count"), (("--junitxml=other.xml",), "r10-admission.xml", "other-case", "ignored", "diagnostics withheld", "args-known"))
    for arguments, name, testcase, message, normal, stage in cases + ((('--junitxml=r10-yasb-experience.xml',), 'r10-yasb-experience.xml', 'final-marker', 'phase=final;timer_timeout_observed=1;timer_timeout_count=1;timer_inactive=1;final_worker_created=1;final_worker_thread_seen=1;final_worker_thread_alive=0;final_worker_deleted=0;owned_process_count=1;owned_processes_exited=1;data_ready_seen=1;finished_seen=1;widget_visible=1;primary_matches_expected=0;alternate_matches_expected=1;primary_visible=1;alternate_visible=0;tooltip_matches_expected=1;path_restored=1', 'phase=final;timer_timeout_observed=1;timer_timeout_count=1;timer_inactive=1;final_worker_created=1;final_worker_thread_seen=1;final_worker_thread_alive=0;final_worker_deleted=0;owned_process_count=1;owned_processes_exited=1;data_ready_seen=1;finished_seen=1;widget_visible=1;primary_matches_expected=0;alternate_matches_expected=1;primary_visible=1;alternate_visible=0;tooltip_matches_expected=1;path_restored=1', None), (('--junitxml=r10-yasb-experience.xml',), 'r10-yasb-experience.xml', 'final-malformed-boolean', 'phase=final;timer_timeout_observed=yes;timer_timeout_count=1;timer_inactive=1;final_worker_created=1;final_worker_thread_seen=1;final_worker_thread_alive=0;final_worker_deleted=0;owned_process_count=1;owned_processes_exited=1;data_ready_seen=1;finished_seen=1;widget_visible=1;primary_matches_expected=0;alternate_matches_expected=1;primary_visible=1;alternate_visible=0;tooltip_matches_expected=1;path_restored=1', 'diagnostics withheld', 'final-marker'), (('--junitxml=r10-yasb-experience.xml',), 'r10-yasb-experience.xml', 'final-unknown', 'phase=final;timer_timeout_observed=1;timer_timeout_count=1;timer_inactive=1;final_worker_created=1;final_worker_thread_seen=1;final_worker_thread_alive=0;final_worker_deleted=0;owned_process_count=1;owned_processes_exited=1;data_ready_seen=1;finished_seen=1;widget_visible=1;primary_matches_expected=0;alternate_matches_expected=1;primary_visible=1;alternate_visible=0;tooltip_matches_expected=1;path_restored=1;unknown=0', 'diagnostics withheld', 'final-marker'), (('--junitxml=r10-yasb-experience.xml',), 'r10-yasb-experience.xml', 'final-oversized', 'phase=final;timer_timeout_observed=1;timer_timeout_count=33;timer_inactive=1;final_worker_created=1;final_worker_thread_seen=1;final_worker_thread_alive=0;final_worker_deleted=0;owned_process_count=1;owned_processes_exited=1;data_ready_seen=1;finished_seen=1;widget_visible=1;primary_matches_expected=0;alternate_matches_expected=1;primary_visible=1;alternate_visible=0;tooltip_matches_expected=1;path_restored=1', 'diagnostics withheld', 'final-marker')):
